...
plot [:300][] "NM/NMGD_0_Monk3_Results.txt" using 2 w lines title "0.0 momentum" lt rgb "red" lw 2, "NM/NMGD_0.3_Monk3_Results.txt" using 2 w lines title "0.3 momentum" lt rgb "blue" lw 2,"NM/NMGD_0.6_Monk3_Results.txt" using 2 w lines title "0.6 momentum" lt rgb "black" lw 2, "NM/NMGD_0.9_Monk3_Results.txt" using 2 w lines title "0.9 momentum" lt rgb "#005A32" lw 2
#    EOF
