...
plot [:300][] "M/MGD_0_Monk2_Results.txt" using 2 w lines title "0.0 momentum" lt rgb "red" lw 2, "M/MGD_0.3_Monk2_Results.txt" using 2 w lines title "0.3 momentum" lt rgb "blue" lw 2,"M/MGD_0.6_Monk2_Results.txt" using 2 w lines title "0.6 momentum" lt rgb "black" lw 2, "M/MGD_0.9_Monk2_Results.txt" using 2 w lines title "0.9 momentum" lt rgb "#005A32" lw 2
#    EOF
