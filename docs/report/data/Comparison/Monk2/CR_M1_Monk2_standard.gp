...
unset ttics
set title "Rate of convergence M1 Monk 2" 
...
minimumLBFGS = 0.068458497822379435
minimumMGD = 0.013742702235183110
minimumNMGD = 0.013741909995351902
minimumPBM = 0.117642940571328833
...
plot [14000:][]"../../LBFGS/Monk2/LBFGS_L1_0.3_Monk2_Results_SMI.txt" using 0:(shiftLBFGS($1), $0 < 1 ? 1/0 : errorLBFGS($1, previousError2LBFGS)) w lines title "LBGFS 3e-4" lt rgb "red" lw 2, "../../MGD/Monk2/M/MGD_0.9_L1_0.0003_Monk2_Results_SMI.txt" using 0:(shiftMGD($1), $0 < 1 ? 1/0 : errorMGD($1, previousError2MGD)) w lines title "MGD 3e-4" lt rgb "blue" lw 2, "../../MGD/Monk2/NM/NMGD_0.9_L1_0.0003_Monk2_Results_SMI.txt" using 0:(shiftNMGD($1), $0 < 1 ? 1/0 : errorNMGD($1, previousError2NMGD)) w lines title "NMGD 3e-4" lt rgb "black" lw 2 , "../../PBM/Monk2/PBM_L1_0.3_Monk2_Results_SMI.txt" using 0:(shiftPBM($1), $0 < 1 ? 1/0 : errorPBM($1, previousError2PBM)) w lines title "PBM 3e-4" lt rgb "#005A32" lw 2
#    EOF