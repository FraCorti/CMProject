...
unset ttics
set title "M2 zoom comparison Monk 1" 
...
minimumLBFGS = 0.000000008916240240
minimumPBM = 0.032260232600586275
...
plot [:200][]  "../../LBFGS/Monk1/LBFGS_L2_0.0003_Monk1_Results_SMI.txt" using 0:(actualResidual($1,minimumLBFGS)) w lines title "LBGFS 3e-4" lt rgb "red" lw 2, "../../MGD/Monk1/NM/NMGD_0.6_L2_0.0003_Monk1_Results_SMI.txt" using 0:(actualResidual($1,minimumNMGD)) w lines title "NMGD 3e-4" lt rgb "black" lw 2, "../../MGD/Monk1/M/MGD_0.6_L2_0.0003_Monk1_Results_SMI.txt" using 0:(actualResidual($1,minimumMGD)) w lines title "MGD 3e-4" lt rgb "blue" lw 2, "../../PBM/Monk1/PBM_L2_0.3_Monk1_Results_SMI.txt" using 0:(actualResidual($1,minimumPBM)) w lines title "PBM 3e-4" lt rgb "#005A32" lw 2
#    EOF