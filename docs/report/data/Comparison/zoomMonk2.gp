...
x = 0.0
GPFUN_f = "f(x) = x"
plot [:30][] "../LBFGS/Monk2/LBFGS_15_Monk2_Results_NoReg.txt" w lines title "LBGFS" lt rgb "red" lw 2, "../SGD/Monk2/SGD_0.9_Monk2_Results.txt" w lines title "SGD" lt rgb "blue" lw 2
#    EOF
