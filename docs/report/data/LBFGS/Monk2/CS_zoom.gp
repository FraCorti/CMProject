...
plot [:15][] "LBFGS_0.0_Monk2_Results.txt" using 2 w lines title "0.0 L2" lt rgb "red" lw 2, "LBFGS_0.0003_Monk2_Results.txt" using 2 w lines title "0.0003 L2" lt rgb "black" lw 2, "LBFGS_0.0005_Monk2_Results.txt" using 2 w lines title "0.0005 L2" lt rgb "#005A32" lw 2, "LBFGS_0.0007_Monk2_Results.txt" using 2 w lines title "0.0007 L2" lt rgb "#4f127b" lw 2
#    EOF
