...
plot [:200][] "PBM_0_Monk1_Results.txt" using 1 w lines title "0.0 L1" lt rgb "red" lw 2, "PBM_0.3_Monk1_Results.txt" using 1 w lines title "0.0003 L1" lt rgb "blue" lw 2,"PBM_0.5_Monk1_Results.txt" using 1 w lines title "0.0005 L1" lt rgb "black" lw 2, "PBM_0.7_Monk1_Results.txt" using 1 w lines title "0.0007 L1" lt rgb "#005A32" lw 2
#    EOF
