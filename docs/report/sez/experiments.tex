...
\begin{center}
	\small\addtolength{\tabcolsep}{-3pt}
		...
		\begin{longtable}{|c|c|c|c|c|c|c|c|c|}
			...
			Monk3 & L-BFGS & 50 & - & 0  & 0 & 8.196e-3 & 1.997e-6 & 8319\\
...
The table \ref{tab:nets_comp} contains the configurations of the networks used to obtain the plots in \S \ref{sec:gradient_norm_convergence_speed}, \S \ref{sec:rate_of_convergence}, \S \ref{sec:computational_time} and \S \ref{sec:residual_error}. 
