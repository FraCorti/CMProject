...
\begin{itemize}
	...
	\begin{equation}
	\parallel f(x_{1},y_{1}) - f(x_{1}) \parallel \leq L(\parallel x_{1}-x_{2}\parallel +  \parallel y_{1}-y_{2}\parallel) \quad \forall (x_{1},y_{1}),(x_{2},y_{2}) \in \textnormal{domain} f.  
	\end{equation} 
	\texttt{TODO}
