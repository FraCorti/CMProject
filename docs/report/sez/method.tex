...
\\
Assumption 1 is satisfied, since our loss function f is twice continuously differentiable as we said in \ref{LF:Properties}. Assumption 2 is also satisfied for properties that the loss function described in section \ref{LF:Properties}.
\\
