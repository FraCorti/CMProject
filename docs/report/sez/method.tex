...
\\
Our objective function is not convex, so we need more constraint in order to use what we said before. The properties shown in \ref*{LF:Properties} ensure the convergence of the method as proved in \cite{gradientProof}.
